      ...
      <div style={background} ref={viewRef}>
        <FadeIn delay={500} visible={inViewport}>
              ...
              >
                <div>
                  ...
                  <p className="legend" style={legendStyle}>
                    Me in front of Gilman Hall at Hopkins!
                  </p>
                </div>
                <div>
                  <img src={Third} alt="" />
                  <p className="legend" style={legendStyle}>
                    One of the opportunities I've had to present Delineo! Design
                    Day 2022
                  </p>
                </div>
                ...
                <div>
                  <img src={Second} alt="" />
                  <p className="legend" style={legendStyle}>
                    Me at Washington Square Park in New York!
                  </p>
                </div>
              </Carousel>
            </div>
          ...
          <div style={isMobile ? textBoxStyleMobile : textBoxStyle}>
            <p style={textStyle}>
              {" "}
              Hello everyone! My name is Christian Bakhit. I am a Junior at
              Johns Hopkins University. My current aspirations have led me to
              the field of AI and robotics research. I hope that one day I can
              work on the first AGI!
            </p>
            <p style={textStyle}>
              {" "}
              I have been coding for a few years now, starting off as a tinkerer
              with Roblox Lua to help build games for me and my friends!
            </p>
            <p style={textStyle}>
              {" "}
              For the past year I have worked in the Delineo Lab. Here, I have
              led the team in solving the problem of simulating disease spread.
            </p>
            <p style={textStyle}>
              We wish to revolutionize the epidemology field, and help lead
              policy for the next pandemic!
            </p>
            <Grid container spacing={10}>
              <Grid item xs={!isMobile ? 5 : 7}>
                <p style={{ color: "#6BD0FF" }}>
                  Some technologies I have experience with are:
                </p>
            ...
            <p style={textStyle}>
              In my time at Hopkins, I have worked with industry leaders, served
              as a student teacher with the PILOT program, and worked on a
              variety of projects!
            </p>
          </div>
        </FadeIn>
