  ...
  return (
    <FadeIn delay={50} transitionDuration={10}>
      <div style={divSplit}>
        ...
        <div style={iconSplit}>
          <Icons
            link="https://github.com/ChrisBJHU"
            type="github"
            stroke="black"
          />
        </div>
        <div style={iconSplit}>
          <Icons
            link="https://twitter.com/ChristianBakhit"
            type="twitter"
            stroke="black"
          />
        </div>
        <div style={iconSplit}>
          <Icons
            link="https://www.linkedin.com/in/christianbakhit/"
            type="linkedin"
            stroke="black"
          />
        </div>
        <div style={iconSplit}>
          <Icons
            link="https://www.instagram.com/chrisbakhit/"
            type="instagram"
            stroke="black"
          />
        </div>
